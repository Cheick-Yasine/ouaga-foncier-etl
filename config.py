...
PROMPT_SYSTEME_LLM = (
    ...
    "un numéro de téléphone/WhatsApp n'est JAMAIS une partie du prix. Exemple : "
    "'prix: 80m' suivi de '226 76 13 54 31' signifie prix_fcfa=80000000 et le "
    "numéro va seulement dans contacts_whatsapp. Ne concatène jamais ces nombres ; "
